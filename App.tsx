                    ...
                    {options.map(option => (
                        ...
                        >
                            <span className={`block truncate ${value === option.value ? 'font-semibold' : 'font-normal'}`}>{option.label}</span>
                             {value === option.value && (
                                <span className="absolute inset-y-0 right-0 flex items-center pr-2 text-brand-red-text">
                ...
                <div className="px-4 pb-4 bg-black/20 border-t border-white/10">
                    ...
                    <div className="space-y-3">
                     ...
                     <div className="flex justify-end gap-2 mt-4 border-t border-white/10 pt-3">
                        ...
                        <button onClick={() => onDelete(client.id)} className="flex items-center gap-1 text-sm bg-brand-red/20 text-brand-red-text px-3 py-1 rounded-md hover:bg-brand-red/40 transition"><TrashIcon className="w-4 h-4" /> Excluir</button>
                    </div>
                </div>
            )}
        </div>
                         ...
                         <>
                            ...
                            <div className="p-4 border-t border-white/10">
                                <form onSubmit={handleSendMessage} className="flex gap-2">
                                    ...
                                    <button type="submit" className="p-3 rounded-md text-white bg-brand-red hover:bg-brand-red-hover"><PaperAirplaneIcon className="w-5 h-5" /></button>
                                </form>
                            </div>
                        </>
                    ) : (
